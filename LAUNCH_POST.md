# Draft de atualização / RT — Janjômetro

Use como resposta/RT no post antigo. Não publicar sem revisão manual final.
...
🚨 O JANJÔMETRO SUBIU DE NÍVEL.

Agora a plataforma mostra, em uma página só:

✅ gastos diretos identificados
✅ equipe/comitiva/contexto separados
✅ CPGF/Presidência sob lupa
✅ Top 10 com fonte rastreável
✅ gráficos por ano/mês
✅ registros recentes com prova
✅ leitura clara: sem fonte, não vira acusação

A regra é simples: se o dinheiro é público, a conta também tem que ser pública.

🔎 Acesse: https://janjometro-0xmanel.vercel.app
...
• sem acusação sem fonte

Agora dá para fiscalizar com mais clareza e menos enrolação.
