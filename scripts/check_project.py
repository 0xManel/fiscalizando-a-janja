...
if html.exists():
    ...
    for token in ["Fiscalizando a JANJA e o PT", "Dinheiro público contra a blindagem", "Veja a conta que o discurso tenta esconder", "Viagens e comidas", "Passos 1, 2 e 3", "Camadas do dossiê", "Links que importam", "Top 10 rastreável", "Prova sem scroll infinito", "Sem fonte, não vira acusação"]:
